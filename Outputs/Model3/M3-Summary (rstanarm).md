...
Chain 1: 
Chain 1:  Elapsed Time: 1154.22 seconds (Warm-up)
Chain 1:                715.995 seconds (Sampling)
Chain 1:                1870.22 seconds (Total)
Chain 1: 
...
Chain 2: 
Chain 2:  Elapsed Time: 1004.57 seconds (Warm-up)
Chain 2:                811.133 seconds (Sampling)
Chain 2:                1815.7 seconds (Total)
Chain 2: 
...
Chain 3: 
Chain 3:  Elapsed Time: 1059.99 seconds (Warm-up)
Chain 3:                840.127 seconds (Sampling)
Chain 3:                1900.12 seconds (Total)
Chain 3: 
...
Chain 4: 
Chain 4:  Elapsed Time: 1013.17 seconds (Warm-up)
Chain 4:                635.78 seconds (Sampling)
Chain 4:                1648.95 seconds (Total)
Chain 4: 
Warning messages:
...
`summary(m3, pars = c("(Intercept)", "sigma", "Sigma[fi_species:(Intercept),(Intercept)]"), probs = c(0.025, 0.975), digits = 2)`
...
[15] "seasonwinter:fi_specieswels"               "b[(Intercept) fi_species:pike]"           
[17] "b[(Intercept) fi_species:pikeperch]"       "b[(Intercept) fi_species:wels]"           
...
`mu_a_sims <- as.matrix(m3, pars = "(Intercept)")`

 - draws for 30 fishes' fi_species-level error

`fish_err <- as.matrix(m3,regex_pars = "b\\[\\(Intercept\\) fi_species\\:")`
...
`signma_y <- as.matrix(m3, pars = "sigma")`

 - draws for sigma_alpha^2

`sigma_alpha <- as.matrix(m3, pars = "Sigma[fi_species:(Intercept),(Intercept)]")`
